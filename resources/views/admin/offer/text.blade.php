...
$head->appendScript('/admin/offer/text.js');
$pageTitle = $pageSubTitle = trans('admin.offer_text.form.title');
$pageMenu = 'offer_text';
?>
@extends('core.layout')
@section('content')
    <form id="edit-form" class="form-horizontal" method="post" action="{{route('admin_offer_text_update')}}">
        <div class="box-body">
